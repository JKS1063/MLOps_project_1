...
def load_object(file_path): # loading object from pickle file
    try:
        with open(file_path, 'rb') as file_obj: # opening file in read binary mode
            return dill.load(file_obj) # loading object from file
